...
Este proyecto contiene un ejemplo de solución **SAM + Jenkins**. Contiene una aplicación API RESTful de libreta de tareas pendientes (ToDo list) y los pipelines que permiten definir el CI/CD para productivizarla.
